<?php
/*
Provider Tri Edr4ISENG
*/
echo @color("blue","───────────────────────────────────────────────────\n");
echo @color("red","                SC TEMBAK KUOTA TRI IND        \n");
echo @color("red","                 TCODE : Edr4JUST4U        \n");
echo @color("red","               INSTAGRAM : @Edraaverill   \n");
echo @color("red","                FACEBOOK : Edra Averil          \n");
echo @color("red","    JANGAN MAU DITIPU DAYA MANUSIA TOLOL /STOP R4KUS\n");
echo @color("red"," Caption : KAMI BERNIAT BAIK, BUKAN UNTUK ORG M4T4 DU1T4N\n");
echo @color("blue","───────────────────────────────────────────────────\n");
echo @color("purple","NB : MASUKIN NOMER TRI LO \t\t: ");
$nomor = trim(fgets(STDIN));
$login = login($nomor);
echo @color('green', $login['message']."\n");
echo @color('purple', "INPUT CODE OTP \t\t: ");
...
if (strpos(json_encode($login), '"status":true')) {
    ...
    if ($beli['status'] == true) {
        echo @color('green', "Sukses Membeli Paket Silakan Tunggu SMS Dari Provider Three\n");
    } else {
        echo @color('red', "Gagal / Sudah melebihi batas pembelian! \n");
    }
